import{R as l}from"./iframe-DJsx_LMI.js";import{D as u}from"./data-editor-all-xo4btEP4.js";import{a as p,d as m,B as f,D as h,P as g}from"./utils-CpGkIYWR.js";import{S as v}from"./story-utils-4UdsftyL.js";import"./preload-helper-Dp1pzeXC.js";import"./image-window-loader-BL-vzFfI.js";import"./throttle-xUL8d2YT.js";import"./marked.esm-B8EVsN7W.js";import"./flatten-DKU9CJY_.js";import"./scrolling-data-grid-D8pm8eI1.js";import"./isArray-C6bsAYrg.js";import"./throttle--dN168Gr.js";const O={title:"Glide-Data-Grid/DataEditor Demos",decorators:[o=>l.createElement(v,null,l.createElement(f,{title:"Custom header icons",description:l.createElement(l.Fragment,null,l.createElement(h,null,"You can provide overrides for the default icons by passing the"," ",l.createElement(g,null,"headerIcons")," prop."))},l.createElement(o,null)))]},t=()=>{const{cols:o,getCellContent:d,onColumnResize:i,setCellValue:s}=p(),a=l.useMemo(()=>{const e=[...o];return e[3]={...e[3],title:"CUSTOM ICON",icon:"custom",width:200},e},[o]),c=l.useMemo(()=>({custom:e=>`<svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>`}),[]);return l.createElement(u,{...m,getCellContent:d,columns:a,onCellEdited:s,onColumnResize:i,headerIcons:c,rows:1e3})};var r,n,C;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent,
    onColumnResize,
