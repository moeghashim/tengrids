import{R as r}from"./iframe-DJsx_LMI.js";import{D as p}from"./data-editor-all-xo4btEP4.js";import{u as f,d as h,B as x,D as g}from"./utils-CpGkIYWR.js";import{S as C}from"./story-utils-4UdsftyL.js";import"./preload-helper-Dp1pzeXC.js";import"./image-window-loader-BL-vzFfI.js";import"./throttle-xUL8d2YT.js";import"./marked.esm-B8EVsN7W.js";import"./flatten-DKU9CJY_.js";import"./scrolling-data-grid-D8pm8eI1.js";import"./isArray-C6bsAYrg.js";import"./throttle--dN168Gr.js";const M={title:"Glide-Data-Grid/DataEditor Demos",decorators:[n=>r.createElement(C,null,r.createElement(x,{title:"Custom Drawing",description:r.createElement(g,null,"You can draw over or under most objects in the grid.")},r.createElement(n,null)))]},o=()=>{const{cols:n,getCellContent:m}=f(1e3,!0,!0),u=r.useCallback((c,l)=>{const{ctx:e,rect:t}=c;e.beginPath(),e.rect(t.x,t.y,t.width,t.height);const a=e.createLinearGradient(0,t.y,0,t.y+t.height);a.addColorStop(0,"#ff00d934"),a.addColorStop(1,"#00a2ff34"),e.fillStyle=a,e.fill(),l()},[]),w=r.useCallback((c,l)=>{l();const{ctx:e,rect:t}=c,a=7;e.beginPath(),e.moveTo(t.x+t.width-a,t.y+1),e.lineTo(t.x+t.width,t.y+a+1),e.lineTo(t.x+t.width,t.y+1),e.closePath(),e.save(),e.fillStyle="#ff0000",e.fill(),e.restore()},[]);return r.createElement(p,{...h,getCellContent:m,columns:n,drawHeader:u,drawCell:w,rows:3e3,rowMarkers:"both"})};var s,i,d;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent
